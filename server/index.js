    ...
    try {
        ...
        const updateDocument = {
            $set: {
                ...
                videogames: formData.videogames,
                reading: formData.reading,
                boardgame: formData.boardgame,
                music: formData.music,
                photography: formData.photography,
                traveling: formData.traveling,
                cookingbaking: formData.cookingbaking,
                paintingdrawing: formData.paintingdrawing,
                gardening: formData.gardening,
                hikingcamping: formData.hikingcamping,
                dancing: formData.dancing,
                yoga: formData.yoga,
                fitness: formData.fitness,
                singing: formData.singing,
                moviestv: formData.moviestv,
